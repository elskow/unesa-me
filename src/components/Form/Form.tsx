                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md md:w-4/6 mb-12">
                        ...
                        <form onSubmit={handleFormSubmit}>
                            <div className="mb-4">
                                ...
                                <input
                                    className="input input-bordered appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="longURL"
                                    type="url"
                            ...
                            >
                                <svg
                                    ...
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    className="stroke-current shrink-0 w-6 h-6 inline"
                                >
                                    <path
                                        strokeLinecap="round"
                            ...
                            {isFetching ? (
                                <div className="flex items-center justify-between mt-4">
                                    <button
                                        disabled
                                        type="button"
                                        className="bg-blue-400 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline inline-flex items-center diss"
                                    >
                                        <svg
                                            aria-hidden="true"
                                            role="status"
